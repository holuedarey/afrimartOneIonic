(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["change-password-change-password-module"], {
  ...
  function srcAppChangePasswordChangePasswordPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_loader_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../core/loader.service */
    ...
    let ChangePasswordPage = class ChangePasswordPage {
      constructor(authService, userService, router, nativeStorage, loadingCtrl, toastController, formBuilder, location, LoaderService) {
        ...
        this.loadingText = "";
        this.changePassword = new src_app_shared_models_user_model__WEBPACK_IMPORTED_MODULE_9__["ChangePasswordModel"](); ///Inputs

        this.title = 'Change Password';
        this.longSearch = false;
        this.showBackButton = true; //  loading: boolean = false;
      ...
      ionViewWillEnter() {// console.log(this.router['routerState'].snapshot.url);
      }
