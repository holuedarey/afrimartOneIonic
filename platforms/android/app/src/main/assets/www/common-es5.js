(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppCoreHttpServicesCategoryServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _common_endpoints__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../common/endpoints */
    ...
    let CategoryService = class CategoryService {
      ...
      searchCategories(searchString, size = 5, hasProducts = true) {
        ...
        return this.http.get("".concat(this.apiUrl, "category/Names?search=").concat(searchString, "&size=").concat(size, "&hasProducts=").concat(hasProducts), {
          headers: this.headerSt()
        });
      }

      getTopCategories(pageSize = 10) {
        return this.http.get("".concat(_common_endpoints__WEBPACK_IMPORTED_MODULE_5__["Endpoint"].CATEGORY.topCategories, "?page=1&pageSize=").concat(pageSize));
      }

      getFeaturedCategories(pageSize = 10) {
        return this.http.get("".concat(this.apiUrl, "resources/featured-categories"), {
          headers: this.headerSt()
        });
      }

      getlevelCategories(levels) {
        return this.http.get("".concat(this.apiUrl, "resources/").concat(levels), {
          headers: this.headerSt()
        });
      }

      getAllCategories() {
        return this.http.get("".concat(this.apiUrl, "categories/root"), {
          headers: this.headerSt()
        });
      }

      getCategoriesById(id) {
        return this.http.get("".concat(this.apiUrl, "categories/").concat(id), {
          headers: this.headerSt()
        });
      }
    ...
    CategoryService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], CategoryService);
    /***/
  },
  ...
  function srcAppCoreHttpServicesStoreServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let StoreService = class StoreService {
      ...
      getStoreDetail(id) {
        const url = "".concat(_common_endpoints__WEBPACK_IMPORTED_MODULE_5__["Endpoint"].STORES.storeDetails).concat(id);
  ...
  /***/
  function srcAppCoreLoaderServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      showLoader(message, duration, cssClass) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          this.loaderToShow = yield this.loadingController.create({
            ...
            cssClass: cssClass || "custom-loader-class" // showBackdrop:false
    ...
    LoaderService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"]])], LoaderService);
    /***/
  },
  ...
  function srcAppSharedModelsUserModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "UserDataModel", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "SliderModel", function () {
      return SliderModel;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "SocialLoginDataModel", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "SendEmailVerificationCodeModel", function () {
      return SendEmailVerificationCodeModel;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "EmailVerificationModel", function () {
      return EmailVerificationModel;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "SendResetPasswordLinkModel", function () {
      return SendResetPasswordLinkModel;
    });
    /* harmony export (binding) */
