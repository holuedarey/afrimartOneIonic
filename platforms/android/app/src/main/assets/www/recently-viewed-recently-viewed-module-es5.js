(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["recently-viewed-recently-viewed-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppRecentlyViewedRecentlyViewedPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRecentlyViewedRecentlyViewedModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RecentlyViewedPageModule", function () {
    ...
    var _recently_viewed_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./recently-viewed.page */
    "./src/app/recently-viewed/recently-viewed.page.ts");

    let RecentlyViewedPageModule = class RecentlyViewedPageModule {};
    RecentlyViewedPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppRecentlyViewedRecentlyViewedPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRecentlyViewedRecentlyViewedPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RecentlyViewedPage", function () {
    ...
    let RecentlyViewedPage = class RecentlyViewedPage {
      ...
      ngOnInit() {
        this.nativeStorage.getItem('currentUser').then(x => {
          this.currentUser = x;
          this.loading = true;
          this.recentlyViewedProducts = this.prodService.getLocalRecentlyViewedProducts() ? this.prodService.getLocalRecentlyViewedProducts() : [];
          this.loading = false;
        });
      }
      ...
      getWishListItems() {
        this.orderService.getWishlist(this.currentUser.token).subscribe(data => {
          if (!data.error) {
            this.products = data.data; // console.log('Wishlist: ' + JSON.stringify(this.products));
          }
        }, err => {
          console.error(err);
        });
      ...
      addToCart(prod) {
        prod['productId'] = prod._id; // console.log('addToCart: ' + JSON.stringify(prod));
        ...
        this.nativeStorage.getItem('currentUser').then(data => {
          ...
          } else {// this.orderService.addToLocalCart(prod, 1);
    ...
    RecentlyViewedPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-recently-viewed',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./recently-viewed.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/recently-viewed/recently-viewed.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./recently-viewed.page.scss */
      "./src/app/recently-viewed/recently-viewed.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_3__["NativeStorage"], src_app_core_http_services_order_service__WEBPACK_IMPORTED_MODULE_5__["OrderService"], src_app_core_http_services_product_service__WEBPACK_IMPORTED_MODULE_6__["ProductService"], src_app_core_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_7__["AuthenticationService"]])], RecentlyViewedPage);
    /***/
  }
}]);
//# sourceMappingURL=recently-viewed-recently-viewed-module-es5.js.map