(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sub-category-sub-category-module"], {
  ...
  function srcAppSubCategorySubCategoryModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _sub_category_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./sub-category.page */
    "./src/app/sub-category/sub-category.page.ts");

    let SubCategoryPageModule = class SubCategoryPageModule {};
    SubCategoryPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppSubCategorySubCategoryPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let SubCategoryPage = class SubCategoryPage {
      ...
      getCategoryProducts(infiniteScroll) {
        ...
        this.productService.getCategoryProductsInfinite(this.catId, this.pageSize, this.page, this.sortStatus).subscribe(data => {
          ...
          if (this.checkIfProdInWishList(prod)) {
            ...
            this.orderService.addToWishlist(this.currentUser.token, {
              ...
              if (!data.error) {
                ...
                this.nativeStorage.setItem('WishList', this.wishList); // console.log('Wishlist Add data:' + this.wishList.length);
    ...
    SubCategoryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/sub-category/sub-category.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sub-category.page.scss */
      "./src/app/sub-category/sub-category.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_core_http_services_order_service__WEBPACK_IMPORTED_MODULE_7__["OrderService"], src_app_core_http_services_product_service__WEBPACK_IMPORTED_MODULE_5__["ProductService"], src_app_core_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_3__["NativeStorage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ActionSheetController"]])], SubCategoryPage);
    /***/
  }
}]);
