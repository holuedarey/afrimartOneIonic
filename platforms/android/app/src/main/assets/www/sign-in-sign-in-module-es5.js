      ...
      loginUser() {
        ...
        this.authService.login(this.loginForm.value).subscribe(data => {
          ...
          if (data.status) {
            ...
            console.log('set data :', this.storageService.get(_core_common_constant__WEBPACK_IMPORTED_MODULE_11__["Constants"].STORAGE_VARIABLES.USER), this.storageService.get(_core_common_constant__WEBPACK_IMPORTED_MODULE_11__["Constants"].STORAGE_VARIABLES.TOKEN)); // this.presentToast('', 'WELCOME ' + data.data['firstname'], 2000, 'success');

            this.navCtrl.navigateForward('/app/home'); // this.nativeStorage.setItem('currentUser', data.data).then(() => {
            //   this.navCtrl.navigateForward('/app/profile');
