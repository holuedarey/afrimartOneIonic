  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let HomePage = class HomePage {
      constructor(categoryService, productService, util, auth, router, nav) {
        ...
        this.auth = auth;
        this.router = router;
        this.nav = nav; // @ViewChild('mySlider', { static: true }) slides: IonSlides;
        ///Inputs
        ...
        this.feautureCategoriesImage = ['/assets/vectors/icons/test2.svg', '/assets/vectors/icons/test3.svg', '/assets/vectors/icons/test4.svg', '/assets/vectors/icons/test5.svg']; // this.util.getSlides().subscribe((val: any) => {
      ...
      ngOnInit() {
        this.getTopProducts();
        this.getFeaturedCatgeories(); // this.getDailyDealsProducts();
      ...
      logScrollEnd() {
        this.showUpArrow = true; // console.log('scroll end');
      }

      logScrollStart() {// console.log('start scrolling : ->');
      }

      logScrolling($event) {// console.log('scrolling event', $event.detail);
      }
      ...
      viewSubCategory(id, title) {
        localStorage.SetTitle = title; // console.log('id :: ', id, 'title :: ', title);

        this.nav.navigateForward(["sub-category/".concat(id)]);
      }

      getTopProducts() {
        this.productService.getTopProducts('test-org').subscribe(res => {
          console.log('rspo ::', res.data.stores[0].products);
          this.topProds = res.data.stores[0].products; // res.data.forEach((e) => {
          //   let prod_id = e.value;
          //   if (prod_id !== null) {
          //     this.productService
      ...
      getFeaturedCatgeories() {
        this.categoryService.getTopCategories().subscribe(data => {
          this.categories = data.data.slice(0, 4); // console.log(
