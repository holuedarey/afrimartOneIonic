(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["wishlist-wishlist-module"], {
  ...
  function srcAppWishlistWishlistPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      getWishListItems() {
        ...
        this.orderService.getWishlist(this.currentUser.token).subscribe(data => {
          if (!data.error) {
            ...
            this.loading = false; // console.log('Wishlist: '+JSON.stringify(this.products))
          }
        }, err => {
          this.loading = false;
          console.error(err);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_4__["NativeStorage"], src_app_core_http_services_order_service__WEBPACK_IMPORTED_MODULE_5__["OrderService"], src_app_core_http_services_product_service__WEBPACK_IMPORTED_MODULE_6__["ProductService"], src_app_core_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_7__["AuthenticationService"]])], WishlistPage);
    /***/
  }
}]);
