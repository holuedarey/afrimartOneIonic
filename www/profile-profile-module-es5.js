(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_common_constant__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../core/common/constant */
    "./src/app/core/common/constant.ts");
    /* harmony import */


    var _core_storage_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    let ProfilePage = class ProfilePage {
      constructor(nativeStorage, authService, productService, userService, router, alertController, toastController, navCtrl, storageService, formBuilder, loadingCtrl) {
        ...
        this.loadingCtrl = loadingCtrl; ///Inputs
      ...
      ionViewWillEnter() {
        console.log('view about to enter'); // console.log('constructor :: ', JSON.parse(localStorage.getItem(Constants.STORAGE_VARIABLES.USER)))
      ...
      editProfile() {
        ...
        this.authService.login(this.profileForm.value).subscribe(data => {
          ...
          this.presentToast('Success', "".concat(data.message), 4000, 'success');
        }, error => {
          this.loadingCtrl.dismiss();
      ...
      logOut() {
        ...
        this.presentToast('', 'Signed out successfully!', 2000, 'success'); // this.nativeStorage.clear().then((isDone) => {
        //   this.currentUser=null;
