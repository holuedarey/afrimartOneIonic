(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppProfileProfilePageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "light {\n  color: #343434 !important;\n}\n\n.progressbar {\n  --buffer-background: #E5E5E5;\n  border-radius: 10px;\n}\n\n.alertX button.alertButton {\n  color: #343434 !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_core_http_services_product_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    let ProfilePage = class ProfilePage {
      ...
      constructor(nativeStorage, authService, productService, userService, router, alertController, toastController, navCtrl) {
        this.nativeStorage = nativeStorage;
        this.authService = authService;
          ...
          if (value !== null) {
            ...
            this.userService.getProfile(this.currentUser.token).subscribe(data => {
              if (!data.error) {
                ...
                if (data.data.cards) {
                  this.nativeStorage.setItem('MyCards', data.data.cards); // console.log('nativeStorage.MyCards:' + this.nativeStorage.getItem('MyCards'));
                }
              } else {
      ...
      ngOnInit() {
        console.log('Init'); // this.nativeStorage.getItem('currentUser').then((value) => {
        //   if (value !== null) {
        //     this.currentUser = value;
        //     console.log('Profile Page:' + JSON.stringify(this.currentUser));
      ...
      logOut() {
        this.nativeStorage.clear().then(isDone => {
          ...
          this.navCtrl.navigateBack('/app/home'); // console.log('Profile Page:' + JSON.stringify(this.currentUser));
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_3__["NativeStorage"], src_app_core_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], src_app_core_http_services_product_service__WEBPACK_IMPORTED_MODULE_7__["ProductService"], src_app_core_http_services_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]])], ProfilePage);
    /***/
  }
}]);
